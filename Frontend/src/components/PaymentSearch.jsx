...
export default function PaymentSearch({ onSearch, onCancel }) {
  ...
  className="flex flex-col md:flex-row md:flex-wrap gap-4 mb-6 items-end bg-gray-100 p-4 rounded-lg"
>
  ...
  <div className="flex gap-2 w-full md:w-auto">
    <button
      type="submit"
      className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-500 hover:cursor-pointer transition w-full md:w-auto"
    >
      Search
    </button>
    ...
    <button
      type="button"
      onClick={onCancel}
      className="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-400 hover:cursor-pointer transition w-full md:w-auto"
    >
      Reset
    </button>
  </div>
